...
//
//     final loginWithGoogleResponse = loginWithGoogleResponseFromJson(jsonString);

LoginWithGoogleResponse loginWithGoogleResponseFromJson(String str) =>
    LoginWithGoogleResponse.fromJson(json.decode(str));

String loginWithGoogleResponseToJson(LoginWithGoogleResponse data) =>
...
class LoginWithGoogleResponse {
  ...
  LoginWithGoogleResponse copyWith({
    int? userId,
    int? contactId,
    int? membershipTypeId,
    String? accessToken,
