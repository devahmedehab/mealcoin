...
class PopulorRestorentWidgets extends StatefulWidget {
  ...
  @override
  State<PopulorRestorentWidgets> createState() =>
      _PopulorRestorentWidgetsState();
}

class _PopulorRestorentWidgetsState extends State<PopulorRestorentWidgets> {
  @override
        ...
        children: [
          ...
          Expanded(
            child: Padding(
              ...
              child: Obx(
                () => !widget.controller.storeLoading.value
                    ? ListView.builder(
                        scrollDirection: Axis.horizontal,
                        shrinkWrap: true,
                        itemCount: widget.controller.populorStore.length,
                        itemBuilder: (context, index) {
                          var item = widget.controller.populorStore[index];
                          return InkWell(
                            onTap: () {
                              widget.controller.addRecentStoreView(item.id!);
                              Get.to(
